...
// in tab_settle/test/features/gemini_service/gemini_service_http_test.dart.
...
import 'package:tab_settle/features/auth_service.dart' as _i9;
...
class _FakeLoggy_3<T extends _i4.LoggyType> extends _i1.SmartFake
    implements _i4.Loggy<T> {
  _FakeLoggy_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockAuthService extends _i1.Mock implements _i9.AuthService {
  ...
  _i4.Loggy<_i4.UiLoggy> get loggy =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeLoggy_3<_i4.UiLoggy>(
              this,
              Invocation.getter(#loggy),
            ),
          )
          as _i4.Loggy<_i4.UiLoggy>);
